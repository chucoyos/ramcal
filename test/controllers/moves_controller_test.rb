...
class MovesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create move" do
    assert_difference("Move.count") do
      post moves_url, params: { move: { container_id: @move.container_id, images: @move.images, mode: @move.mode, move_type: @move.move_type, notes: @move.notes, status: @move.status } }
    end
  ...
  test "should update move" do
    patch move_url(@move), params: { move: { container_id: @move.container_id, images: @move.images, mode: @move.mode, move_type: @move.move_type, notes: @move.notes, status: @move.status } }
