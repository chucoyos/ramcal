...
class ContainersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create container" do
    assert_difference("Container.count") do
      post containers_url, params: { container: { cargo_owner: @container.cargo_owner, container_type: @container.container_type, number: @container.number, size: @container.size, user_id: @container.user_id } }
    end
  ...
  test "should update container" do
    patch container_url(@container), params: { container: { cargo_owner: @container.cargo_owner, container_type: @container.container_type, number: @container.number, size: @container.size, user_id: @container.user_id } }
