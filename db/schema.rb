...
ActiveRecord::Schema[7.2].define(version: 2025_01_21_173302) do
  ...
  create_table "invoices", force: :cascade do |t|
    ...
    t.index ["container_id"], name: "index_invoices_on_container_id"
  ...
  add_foreign_key "invoices", "containers"
